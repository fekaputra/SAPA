...
public class KnowledgeLibrary extends ListActivity 
{
    ...
    private static String url_all_files = Referensi.url + "/listlibrary.php";
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        case R.id.image:
			...
			image.putExtra("category", "library");
	    	startActivity(image);
            return true;
        ...
        case R.id.audio:
			...
			audio.putExtra("category", "library");
	    	startActivity(audio);
            return true;
        ...
        case R.id.video:
			...
			video.putExtra("category", "library");
	    	startActivity(video);
            return true;
