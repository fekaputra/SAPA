...
public class DocumentsActivity extends ListActivity 
{
    ...
    private void fill(File f)
    {
		 ...
		 adapter = new FileArrayAdapter(DocumentsActivity.this,R.layout.photos_layout,dir);
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        case R.id.menu_bookmark:
            ...
            Toast.makeText(DocumentsActivity.this, "Bookmark is Selected", Toast.LENGTH_SHORT).show();
            return true;
        case R.id.menu_save:
        	Toast.makeText(DocumentsActivity.this, "Save is Selected", Toast.LENGTH_SHORT).show();
            return true;
        case R.id.menu_search:
        	Toast.makeText(DocumentsActivity.this, "Search is Selected", Toast.LENGTH_SHORT).show();
            return true;
        case R.id.menu_share:
        	Toast.makeText(DocumentsActivity.this, "Share is Selected", Toast.LENGTH_SHORT).show();
            return true;
        case R.id.menu_delete:
        	Toast.makeText(DocumentsActivity.this, "Delete is Selected", Toast.LENGTH_SHORT).show();
            return true;
        case R.id.menu_preferences:
        	Toast.makeText(DocumentsActivity.this, "Preferences is Selected", Toast.LENGTH_SHORT).show();
            return true;
        default:
...
import com.halamanlogin.DocumentsActivity.LoadAllFiles;
...
public class DocumentsActivity extends ListActivity 
{
    ...
    private static String url_all_files = "http://fajarjuang.com/android/listdocument.php";
            ...
            runOnUiThread(new Runnable() 
            {
                public void run() 
                {
                    ...
                    ListAdapter adapter = new SimpleAdapter(
                            DocumentsActivity.this, fileList,
