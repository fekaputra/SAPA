...
public class SongsActivity extends ListActivity {
    ...
    private void fill(File f)
    {
		 ...
		 adapter = new FileArrayAdapter(SongsActivity.this,R.layout.photos_layout,dir);
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        case R.id.menu_bookmark:
            ...
            Toast.makeText(SongsActivity.this, "Bookmark is Selected", Toast.LENGTH_SHORT).show();
            return true;
        case R.id.menu_save:
        	Toast.makeText(SongsActivity.this, "Save is Selected", Toast.LENGTH_SHORT).show();
            return true;
        case R.id.menu_search:
        	Toast.makeText(SongsActivity.this, "Search is Selected", Toast.LENGTH_SHORT).show();
            return true;
        case R.id.menu_share:
        	Toast.makeText(SongsActivity.this, "Share is Selected", Toast.LENGTH_SHORT).show();
            return true;
        case R.id.menu_delete:
        	Toast.makeText(SongsActivity.this, "Delete is Selected", Toast.LENGTH_SHORT).show();
            return true;
        case R.id.menu_preferences:
        	Toast.makeText(SongsActivity.this, "Preferences is Selected", Toast.LENGTH_SHORT).show();
            return true;
        default:
...
import com.halamanlogin.SongsActivity.LoadAllFiles;
...
public class SongsActivity extends ListActivity 
{
    ...
    private static String url_all_files = "http://fajarjuang.com/android/listaudio.php";
