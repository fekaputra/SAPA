...
public class KnowledgeNews extends ListActivity 
{
    ...
    private static String url_all_files = "http://fajarjuang.com/android/listnews.php";
    ...
    {    	
		...
		{
			super.onPreExecute();
			pDialog = new ProgressDialog(KnowledgeNews.this);
